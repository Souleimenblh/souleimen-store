                        ...
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body">
                                <div class="clearfix mb-3">
                                    <span class="float-start badge rounded-pill bg-success"><?php echo $product['product_price'];?>DT</span>

                                    <span class="float-end"><del><?php echo $product['old_price']; ?>DT</del></span>
                                </div>
                                <h5 class="card-title">
