      ...
      <div class="col-10">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <p class="mb-0"><span class="text-muted">Total TTC:</span> <strong id="amount" data-amount="<?php echo $_SESSION["totaux"];?>">
                                <?php echo isset($_SESSION["totaux"]) ? $_SESSION["totaux"] : 0;?> <span class="bb-danger">DT</span>
                            </strong></p>
            </div>
...
<!-- ceci pour afficher tous les preduit  -->
                    ...
                    <div class="card rounded-3 mb-4">
                        <div class="card-body p-4">
                            ...
                            <div class="col-md-3 col-lg-3 col-xl-3">
                                ...
                                <p> <span class="text-muted">Price: </span><?php echo $product["price"];?> DT</p>
                            </div>
                            ...
                            <h6 class="mb-0"><span class="text-muted">Total: </span><?php echo $product["total"];?> DT</h6>
                            </div>
...
<!-- parti paypal: nb:juste pour test -->
                    <div class="container">
                    <div class="container">
